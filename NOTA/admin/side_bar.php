<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:#5cb85c;color:white;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/projects/NOTA-Automated/index.html" style = "color:white;"><i class = "fa fa-home fa-large" > </i> NOTA Automated Voting Platform</a>
            ...
            <ul class="nav navbar-top-links navbar-right">
			 ...
			 ?>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style = "background-color:#5cb85c;color:White;">
